  ...
  return (
    <div className='md:px-12 p-4 max-w-screen-2xl mx-auto mt-24'>
      <div className=' flex-col md:flex-row md:items-center'>
        ...
        <div className='flex flex-col md:flex-row md:justify-between md:items-center md:ml-8'>
          ...
          <div className="flex justify-center mt-8 space-x-2">
            <button className="bg-grn text-white px-6 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400">For Individuals</button>
